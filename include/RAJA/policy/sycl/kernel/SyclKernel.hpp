...
/*    std::cout << "Blocks.x = " << launch_dims.global.x
              << "\nBlocks.y = " << launch_dims.global.y
              << "\nBlocks.z = " << launch_dims.global.z
...
*/
    stream.submit([&](cl::sycl::handler& h) {
      ...
      h.parallel_for(launch_dims.fit_nd_range(),
        ...
        SyclKernelLauncher/*Fixed*/</*256,*/ Data, executor_t>(*d_data, item);
